...
<div class="activities index">
	...
	<tr>
		...
		<td><?php echo h($activity['Activity']['Subject']); ?>&nbsp;</td>
                ...
                <td><a href="/<?php echo Configure::read('SITENAME');?>/opportunities/showCompanyOpportunityDetail/<?php echo $activity['Contact']['CrmCompany']['id']; ?>"><?php echo h($activity['Contact']['CrmCompany']['Company_Name']); ?>&nbsp;</td>
                <td><a href="/<?php echo Configure::read('SITENAME');?>/opportunities/showContactOpportunityDetail/<?php echo $activity['Contact']['id']; ?>"><?php echo h($activity['Contact']['Contact_Email']); ?>&nbsp;</td>
                <td>
                ...
                <td><?php echo h($activity['Opportunity']['Opportunity_Name']); ?>&nbsp;</td>
